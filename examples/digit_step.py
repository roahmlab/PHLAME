...
p = 8  # Number of Chebyshev nodes
k = 1e7  # Penalty parameter
...
max_steps = 1e8
ns_points = int(1e2)
run_name = "Step-Digit"  # Name of the run
...
FOLDER_SCENARIOS = os.path.abspath(os.path.join(base_dir, "scenarios/digit_scenarios/"))
SCENARIO_NAME = "scenario_example_step.mat"
FP_SCENARIO = os.path.join(FOLDER_SCENARIOS, SCENARIO_NAME)
...
solution = solve_ivp(lam_ode, t_simul, X0.squeeze(), method='BDF', t_eval=t_interp)
